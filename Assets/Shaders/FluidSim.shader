    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float g = bufCol.b * (1. - bufCol.r) + (bufCol.b * 2. - bufCol.r / 2) * bufCol.r;                 //in fluid, blue turns to green. in solid, green remains so it can radiate after an object moves.
